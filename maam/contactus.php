...
<h2 style="color: white">HAVE A QUERY...CONTACT US!</h2>
<form>
  ...
  <div class="form-group text-light">
    <label for="exampleFormControlSelect2"><b>Problem:</b></label>
    <select multiple class="form-control" id="exampleFormControlSelect2">
      <option>1.Not able to run php code</option>
      <option>2.have a doubt in bootstrap</option>
      <option>3.Unable to use css properly</option>
      <option>4.have a problem in html</option>
      <option>5.unable to set up wordpress</option>
    </select>
  </div>
  <div class="form-group text-light">
   ...
   <input type="submit" name="submit" value="Send" class="btn btn-danger btn-lg">
</form>
    </div>
    </div>
